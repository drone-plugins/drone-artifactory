...
func TestParseJFrogDetailedSummary_FlatSHA256(t *testing.T) {
  ...
  "files": [{
    "sourcePath": "myfolder/app.jar",
    "targetPath": "libs-release/app.jar",
    "sha256": "deadbeef"
  }]
}`)
...
func TestParseJFrogDetailedSummary_NestedChecksum(t *testing.T) {
	// Some JFrog CLI versions nest sha256 under "checksum".
	raw := jfrogOutput(`{
  "status": "success",
  "totals": {"success": 1, "failure": 0},
  "files": [{
    "sourcePath": "build/lib.jar",
    "targetPath": "repo/lib.jar",
    "checksum": {"sha256": "cafebabe", "sha1": "aaa"}
  }]
}`)
...
func TestParseJFrogDetailedSummary_MultipleFiles(t *testing.T) {
  ...
  "files": [
    {"sourcePath": "myfolder/a.jar", "targetPath": "pcf/newdevtest/a.jar", "sha256": "aaa"},
    {"sourcePath": "myfolder/b.jar", "targetPath": "pcf/newdevtest/b.jar", "sha256": "bbb"},
    {"sourcePath": "myfolder/c.jar", "targetPath": "pcf/newdevtest/c.jar", "sha256": "ccc"}
  ]
}`)
...
func TestParseJFrogDetailedSummary_SkipsEmptyPaths(t *testing.T) {
	// An entry without sourcePath/targetPath should be silently skipped.
	raw := jfrogOutput(`{
  "status": "success",
  "totals": {"success": 2, "failure": 0},
  "files": [
    {"sourcePath": "", "targetPath": "", "sha256": "aaa"},
    {"sourcePath": "src/good.jar", "targetPath": "repo/good.jar", "sha256": "bbb"}
  ]
}`)
...
func TestParseJFrogDetailedSummary_BaseURLTrailingSlashNormalised(t *testing.T) {
	raw := jfrogOutput(`{"status":"success","files":[{"sourcePath":"src/f.jar","targetPath":"repo/f.jar","sha256":"x"}]}`)
